...
class App
{
    ...
    public static function run(): void
    {
        ...
        if (class_exists(Env::class) && file_exists(base_path(false) . '/.env') && method_exists(Env::class, 'load')) {
        ...
        if ($config['listen']) {
            ...
            $worker->onWorkerStart = function ($worker) {
                ...
                $app = new CoreApp(config('app.request_class', Request::class), Log::channel(), app_path(), public_path());
